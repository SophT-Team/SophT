...
def create_fish_geometry_2D(rest_lengths):
    """
    TODO docs
    Parameters
    ----------
...
def create_fish_geometry_3D(rest_lengths):
    """
    TODO docs
    Parameters
    ----------
...
def update_rod_for_fish_geometry_2D(density, youngs_modulus, rod):
    """
    TODO: docs
    ...
    width, height = create_fish_geometry_2D(rod.rest_lengths)
...
def update_rod_for_fish_geometry_3D(density, youngs_modulus, rod):
    """
    TODO: docs
    ...
    width, height = create_fish_geometry_3D(rod.rest_lengths)
