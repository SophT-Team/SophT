...
class EulerianLagrangianGridCommunicator3D:
    """Class for communication between Eulerian and Lagrangian grids in 3D.
...
def generate_local_eulerian_grid_support_of_lagrangian_grid_kernel_3d(
    ...
    """
    Generate kernel that computes local Eulerian support of Lagrangian grid in 3D.
    ...
    def local_eulerian_grid_support_of_lagrangian_grid_kernel_3d(
        ...
        # Note that in case where lagrangian grid positions coincide with an eulerian
        ...
        local_eul_grid_support_of_lag_grid[...] = (
            ...
            * dx
            + eul_grid_coord_shift
            - lag_positions.reshape(grid_dim, 1, 1, 1, num_lag_nodes)
        )
    ...
    def local_eulerian_grid_support_of_lagrangian_grid_kernel_3d(
        ...
        for i in range(0, num_lag_nodes):
            ...
            local_eul_grid_support_of_lag_grid[2, ..., i] = (
                (
                    nearest_eul_grid_index_to_lag_grid[1, i]
                    + local_eul_grid_support_idx[2]
                )
                * dx
                + eul_grid_coord_shift
                - lag_positions[2, i]
...
def generate_eulerian_to_lagrangian_grid_interpolation_kernel_3d(
    ...
    """Generate kernel that interpolates a 3D field from Eulerian grid to a Lagrangian grid.
    ...
    def vector_field_eulerian_to_lagrangian_grid_interpolation_kernel_3d(
        ...
        """Interpolate a 3D Eulerian vector field onto a Lagrangian vector field.
...
def generate_lagrangian_to_eulerian_grid_interpolation_kernel_3d(
    ...
    """Generate kernel that interpolates a 3D field from Lagrangian to an Eulerian grid.
    ...
    def lagrangian_to_eulerian_grid_interpolation_kernel_3d(
        ...
        """Interpolate a 3D Lagrangian field onto an Eulerian field.
