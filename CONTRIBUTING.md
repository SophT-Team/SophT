## Contributing to SophT

Thanks for taking the time to contribute!

The following is a set of guidelines for contributing to SophT. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.

#### Table Of Contents

[TLDR! I need three-line summary!!](#three-line-summary)
...
* Include **additional details** as much as possible.
	...
	* Which **version of SophT and dependencies** was used.
...
If you are unsure regarding how to start contributing to SophT, you can look through `good first issue` and `help wanted` labels.
...
We also have many related projects in separate repositories that utilize the SophT as a core library.
...
Ask any question about **how to use SophT and detail implementation** in the **issue with label:question**.
